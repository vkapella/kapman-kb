...
| Entry-time Wyckoff regime | Advisory-required (Wyckoff branch) | positions.md (journal; written at Pass 2) | Confirmed regime at entry session (one of the seven; the exempt-snapshot Wyckoff field holds the regime per D-d). Drives the regime-succession sub-branch |
